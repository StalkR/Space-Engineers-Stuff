...
WCThreatsScratchpad);foreach(var target in WCThreatsScratchpad.Keys){MyDetectedEntityInfo entityInfo=target;if(targetManager.UpdateTarget(ref entityInfo,
